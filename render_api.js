...
module.exports={
ligar:()=>api('POST',`/services/${SID}/resume`),
desligar:()=>api('POST',`/services/${SID}/suspend`),
reiniciar:()=>api('POST',`/services/${SID}/deploys`,{clearCache:'do_not_clear'}),
status:()=>api('GET',`/services/${SID}`)
};
