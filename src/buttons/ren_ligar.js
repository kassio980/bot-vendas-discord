...
await i.deferUpdate();
try{const r=await ren.ligar();const b=JSON.parse(r.raw||'{}');
await i.followUp({embeds:[info('Comando enviado','Ligando... Status: `'+(b.service?.status||r.status)+'`')],ephemeral:true})
